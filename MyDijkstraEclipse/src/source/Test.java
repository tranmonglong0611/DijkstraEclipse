...
public class Test {
	...
	private void setInitial() {
		...
		timeGraph = new JTextArea("   ");
		JLabel t2 = new JLabel("Time to do Dijkstra: ");
		
		timeDijkstra = new JTextArea("   ");
	...
	private void initUI() {
		...
		JMenuItem normalHeapUsing = new JMenuItem("Binary Heap");
	...
	private void heapDijkstra(HeapInterface heap) throws InputMismatchException, FileNotFoundException {
		...
		for (int i=0; i < graph.numOfVertex; i++) {
			textDijkstra.append(dijkstra.minPath(graph, i));			
		}
